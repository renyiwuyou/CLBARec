...
def main():
    ...
    parser.add_argument("--contrast_tau", type=float, default=0.5, help="Temperature for contrastive learning")
    parser.add_argument("--contrast_weight", type=float, default=1.0, help="Weight of contrastive loss in joint loss")
    ...
    # model args
    parser.add_argument("--model_name", default='CLBARec', type=str)
